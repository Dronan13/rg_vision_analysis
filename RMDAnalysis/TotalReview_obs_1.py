...
#1 ROBOTS
df1_1 = pd.read_json('E:/experiments/obstacles#1/mode_Group#1/R1/frames/FE1.json')
r11_map = np.rot90(np.loadtxt('E:/experiments/obstacles#1/mode_Group#1/R1/maps/M1.txt'))
r11_map = np.logical_not(r11_map).astype(int)
sum_map1 = r11_map

#2 ROBOTS
df2_1 = pd.read_json('E:/experiments/obstacles#1/mode_Group#2/R1/frames/FE1.json')
df2_2 = pd.read_json('E:/experiments/obstacles#1/mode_Group#2/R2/frames/FE1.json')
r21_map = np.rot90(np.loadtxt('E:/experiments/obstacles#1/mode_Group#2/R1/maps/M1.txt'))
r21_map = np.logical_not(r21_map).astype(int)
r22_map = np.rot90(np.loadtxt('E:/experiments/obstacles#1/mode_Group#2/R2/maps/M1.txt'))
r22_map = np.logical_not(r22_map).astype(int)
sum_map2 = np.add(r21_map, r22_map)

#3 ROBOTS
df3_1 = pd.read_json('E:/experiments/obstacles#1/mode_Group#3/R1/frames/FE1.json')
df3_2 = pd.read_json('E:/experiments/obstacles#1/mode_Group#3/R2/frames/FE1.json')
df3_3 = pd.read_json('E:/experiments/obstacles#1/mode_Group#3/R3/frames/FE1.json')
r31_map = np.rot90(np.loadtxt('E:/experiments/obstacles#1/mode_Group#3/R1/maps/M1.txt'))
r31_map = np.logical_not(r31_map).astype(int)
r32_map = np.rot90(np.loadtxt('E:/experiments/obstacles#1/mode_Group#3/R2/maps/M1.txt'))
r32_map = np.logical_not(r32_map).astype(int)
r33_map = np.rot90(np.loadtxt('E:/experiments/obstacles#1/mode_Group#3/R3/maps/M1.txt'))
r33_map = np.logical_not(r33_map).astype(int)
sum_map3 = np.add(np.add(r31_map, r32_map), r33_map)

#4 ROBOTS
df4_1 = pd.read_json('E:/experiments/obstacles#1/mode_Group#4/R1/frames/FE1.json')
df4_2 = pd.read_json('E:/experiments/obstacles#1/mode_Group#4/R2/frames/FE1.json')
df4_3 = pd.read_json('E:/experiments/obstacles#1/mode_Group#4/R3/frames/FE1.json')
df4_4 = pd.read_json('E:/experiments/obstacles#1/mode_Group#4/R4/frames/FE1.json')
r41_map = np.rot90(np.loadtxt('E:/experiments/obstacles#1/mode_Group#4/R1/maps/M1.txt'))
r41_map = np.logical_not(r41_map).astype(int)
r42_map = np.rot90(np.loadtxt('E:/experiments/obstacles#1/mode_Group#4/R2/maps/M1.txt'))
r42_map = np.logical_not(r42_map).astype(int)
r43_map = np.rot90(np.loadtxt('E:/experiments/obstacles#1/mode_Group#4/R3/maps/M1.txt'))
r43_map = np.logical_not(r43_map).astype(int)
r44_map = np.rot90(np.loadtxt('E:/experiments/obstacles#1/mode_Group#4/R4/maps/M1.txt'))
r44_map = np.logical_not(r44_map).astype(int)
sum_map4 = np.add(np.add(r41_map, r42_map), np.add(r43_map, r44_map))

#5 ROBOTS
df5_1 = pd.read_json('E:/experiments/obstacles#1/mode_Group#5/R1/frames/FE1.json')
df5_2 = pd.read_json('E:/experiments/obstacles#1/mode_Group#5/R2/frames/FE1.json')
df5_3 = pd.read_json('E:/experiments/obstacles#1/mode_Group#5/R3/frames/FE1.json')
df5_4 = pd.read_json('E:/experiments/obstacles#1/mode_Group#5/R4/frames/FE1.json')
df5_5 = pd.read_json('E:/experiments/obstacles#1/mode_Group#5/R5/frames/FE1.json')
r51_map = np.rot90(np.loadtxt('E:/experiments/obstacles#1/mode_Group#5/R1/maps/M1.txt'))
r51_map = np.logical_not(r51_map).astype(int)
r52_map = np.rot90(np.loadtxt('E:/experiments/obstacles#1/mode_Group#5/R2/maps/M1.txt'))
r52_map = np.logical_not(r52_map).astype(int)
r53_map = np.rot90(np.loadtxt('E:/experiments/obstacles#1/mode_Group#5/R3/maps/M1.txt'))
r53_map = np.logical_not(r53_map).astype(int)
r54_map = np.rot90(np.loadtxt('E:/experiments/obstacles#1/mode_Group#5/R4/maps/M1.txt'))
r54_map = np.logical_not(r54_map).astype(int)
r55_map = np.rot90(np.loadtxt('E:/experiments/obstacles#1/mode_Group#5/R5/maps/M1.txt'))
...
fig = plt.figure()
ax = fig.add_subplot(111)
sums_grid1 = np.loadtxt('E:/experiments/obstacles#1/mode_Group#1/common/maps/sums.txt').astype(int)#3766 #3763
sums_grid2 = np.loadtxt('E:/experiments/obstacles#1/mode_Group#2/common/maps/sums.txt').astype(int)[::2]#1696 #3370
sums_grid3 = np.loadtxt('E:/experiments/obstacles#1/mode_Group#3/common/maps/sums.txt').astype(int)[::3]#1270 #3789
sums_grid4 = np.loadtxt('E:/experiments/obstacles#1/mode_Group#4/common/maps/sums.txt').astype(int)[::4]#766 #3040
sums_grid5 = np.loadtxt('E:/experiments/obstacles#1/mode_Group#5/common/maps/sums.txt').astype(int)[::5]#714 #3535
